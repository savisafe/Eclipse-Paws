...
Доступны первые три мира кампании: Сад первой зари, Лес шепчущих теней и Небесная библиотека.
Каждый имеет собственный фон, roster врагов, mini-boss и фазовую механику. Пройденный уровень
открывает следующий в меню выбора.
