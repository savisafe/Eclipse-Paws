...
// intentionally short and generic, using only the canon names Люмус/Нокс, and do not invent
// specific plot beats that belong to a future narrative pass.
export interface DialogueBeat {
  speaker: 'Люмус' | 'Нокс' | 'Голос сна';
  text: string;
...
export const CAMPAIGN_DIALOGUES: Readonly<Record<CampaignLevelId, readonly DialogueBeat[]>> = {
  'garden-first-dawn': [
    { speaker: 'Люмус', text: 'Здесь тепло. Но утро не двигается с места.', tone: 'light' },
  ...
  'whispering-lanterns': [
    ...
    { speaker: 'Люмус', text: 'Тогда мы поможем нести свет дальше.', tone: 'light' },
  ],
  'midday-clock-city': [
    { speaker: 'Люмус', text: 'Все спешат. Никто не смотрит на часы.', tone: 'light' },
  ...
  'forgotten-smiles-carnival': [
    { speaker: 'Люмус', text: 'Праздник красивый. Но повторяется по кругу.', tone: 'light' },
  ...
  'last-star-field': [
    ...
    { speaker: 'Люмус', text: 'Останемся рядом столько, сколько нужно.', tone: 'light' },
  ],
  'eternal-sleep-heart': [
    { speaker: 'Люмус', text: 'Мы дошли. Дальше — только вместе.', tone: 'light' },
