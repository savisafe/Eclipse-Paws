...
import { PROTOTYPE_ABILITIES, PROTOTYPE_SPECIAL_ABILITIES } from '../abilities/prototype-abilities';
...
export const PROTOTYPE_SPAWNS = {
  ...
  enemies: [
    ...
    { configId: 'spore-beast', id: 'spore-beast-2', x: 2960, y: 475 },
  ],
} as const;
